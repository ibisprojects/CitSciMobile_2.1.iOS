...
#import "AddObservationEnter.h"
#import "../Model/Model.h"
#import "../AppDelegate.h"

@interface AddObservationEnter ()

@end

@implementation AddObservationEnter
...
-(id)init
{
    ...
    if ([[UIScreen mainScreen] bounds].size.height == 568)
    {
        ...
        {
            self = [self initWithNibName:@"AddObservationEnterSkipAndCamera_iphone5" bundle:nil];
        }
        else
        {
            self = [self initWithNibName:@"AddObservationEnter_iphone5" bundle:nil];
        }
    }
    else
    {
        ...
        if(NewOrganism && (SiteType == COLLECTORGANISM))
        {
            self = [self initWithNibName:@"AddObservationEnterSkipAndCamera" bundle:nil];
        }
        else
        {
            self = [self initWithNibName:@"AddObservationEnter" bundle:nil];
        }
    }
...
- (void)viewDidLoad
{
    ...
    self.SelectionEnterInput.inputAccessoryView = numberToolbar;
    *****/
}
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    {
        self.SelectionEnterInput.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
    }
