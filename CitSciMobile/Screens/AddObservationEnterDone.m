...
#import "AddObservationEnterDone.h"
#import "../Model/Model.h"
#import "../AppDelegate.h"

@interface AddObservationEnterDone ()

@end

@implementation AddObservationEnterDone
...
// debugging
//
Boolean EnterDoneContinue = false;
Boolean AddEnterDoneDebug = false;
...
-(IBAction)DoneButton:(int)intNewView
{
    ...
    ********/
    ...
    if(Success)
    {
        AddEnterDoneDebug = false;
        if(AddEnterDoneDebug) [TheOptions DumpAttributeDataValues];
        AddEnterDoneDebug = false;
...
-(id)init
{
    ...
    if ([[UIScreen mainScreen] bounds].size.height == 568)
    {
        ...
        {
            self = [self initWithNibName:@"AddObservationEnterDoneSkipAndCamera_iphone5" bundle:nil];
        }
        else
        {
            self = [self initWithNibName:@"AddObservationEnterDone_iphone5" bundle:nil];
        }
    }
    else
    {
        ...
        if(NewOrganism && (SiteType == COLLECTORGANISM))
        {
            self = [self initWithNibName:@"AddObservationEnterDoneSkipAndCamera" bundle:nil];
        }
        else
        {
            self = [self initWithNibName:@"AddObservationEnterDone" bundle:nil];
        }
    }
...
- (void)viewDidLoad
{
    ...
    self.SelectionEnterDoneInput.inputAccessoryView = numberToolbar;
    *****/
}
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [TheOptions SetCurrentViewValue:ADDOBSERVATIONENTERDONE];
    ...
    u                       = [TheOptions GetUnitAbbreviation];
    self.TheUnits.text      = [u objectAtIndex:AttributeIndex];
    if([self.TheUnits.text length] !=0)
    {
        self.SelectionEnterDoneInput.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
    }
