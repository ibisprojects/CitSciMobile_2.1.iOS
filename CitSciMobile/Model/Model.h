...
#define PROFILE_URL             @"https://ibis-apis-test.nrel.colostate.edu/app.php/API/GetProfile"
#define PROJECTLIST_URL         @"https://ibis-apis-test.nrel.colostate.edu/app.php/API/GetProjectList?Token="
